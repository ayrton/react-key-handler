...
export default class KeyHandler extends React.Component {
  ...
  componentWillUnmount(): void {
    ...
    window.document.removeEventListener(this.props.keyEventName, this.handleKeyUp);
  }
  ...
  return (component) => {
    return class KeyHandleDecorator extends React.Component {
      ...
      render(): ReactElement {
        return (
          <div>
            <KeyHandler keyCode={keyCode} onKeyHandle={this.handleKeyChange} />
      ...
      handleKeyChange(event: KeyboardEvent): void {
